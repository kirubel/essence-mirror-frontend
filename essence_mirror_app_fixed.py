    ...
    if st.checkbox("🔧 Show Debug Info", key="debug_toggle"):
        with st.expander("Debug Information"):
            st.json({
                ...
                "recommendations_generated": st.session_state.recommendations_generated,
                "has_collage_data": hasattr(st.session_state, 'collage_data') and st.session_state.collage_data is not None
            })
