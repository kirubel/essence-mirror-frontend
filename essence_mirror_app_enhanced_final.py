...
# Import the enhanced Style Reel component
from style_reel_component_enhanced import render_style_reel_tab
...
def main():
    ...
    with st.sidebar:
        ...
        if STYLE_REEL_ENABLED:
            st.markdown("✅ Enhanced Style Videos (Advanced Image Analysis)")
        else:
        ...
        st.markdown("• Videos match your image's visual style")
        st.markdown("• AI analyzes colors, lighting & composition")
    ...
    if STYLE_REEL_ENABLED:
        tab1, tab2, tab3 = st.tabs(["📊 Style Analysis", "🎨 Visual Collages", "🎬 Enhanced Style Videos"])
    else:
    ...
    # Tab 3: Enhanced Style Videos (if enabled)
    if STYLE_REEL_ENABLED:
        with tab3:
    ...
    # Footer
    st.markdown("---")
    st.markdown("*Powered by Amazon Bedrock, Nova Pro AI, Nova Canvas, and Enhanced Nova Reel*")
    st.markdown("**🚀 NEW:** Advanced Image Analysis creates videos that match your image's colors, lighting, composition, and style!")
