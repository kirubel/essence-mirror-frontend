...
# Import the fixed Style Reel component
from style_reel_component_fixed import render_style_reel_tab
...
def main():
    ...
    with st.sidebar:
        ...
        if STYLE_REEL_ENABLED:
            st.markdown("✅ Style Videos (Nova Reel - Fixed Auth)")
        else:
        ...
        st.markdown("• Videos are 6 seconds (Nova Reel requirement)")
    ...
    st.markdown("**🔧 Fixed Issues:** MIME type handling, Nova Reel authentication, 6-second duration requirement")
